...
class Split extends react_1.default.Component {
    constructor(props) {
        ...
        this.startResize = (clientX, clientY) => {
            this.setState(state => (Object.assign(Object.assign({}, state), { size: state.size === -1 ? this.getMainSize() : state.size, isResizing: true })));
        };
        this.resize = (clientPosition) => {
            let newSize = -1;
            if (this.getSecondOffset() < this.getMainOffset() ||
