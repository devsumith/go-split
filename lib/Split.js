...
class Split extends react_1.default.Component {
    constructor(props) {
        ...
        this.startResize = (clientX, clientY) => {
            this.setState(state => (Object.assign(Object.assign({}, state), { size: state.size === -1 ? state.mainSize : state.size, isResizing: true })));
        };
        this.resize = (clientX, clientY) => {
            let newSize = -1;
        ...
        this.setSize = (size) => {
            ...
            if (sideSize !== -1) {
                if (sideSize < newSize + this.state.sticky) {
                    newSize = sideSize;
                }
            }
            this.setState(state => (Object.assign(Object.assign({}, state), { size: newSize })));
        };
