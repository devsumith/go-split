...
export class Split extends React.Component {
    constructor(props) {
        ...
        this.setDisable = (disable) => {
            ...
            (_b = (_a = this.props).onDisable) === null || _b === void 0 ? void 0 : _b.call(_a, disable);
        };
        ...
        this.state = Object.assign(Object.assign({}, defaultState), { isFixed: !!props.mode, split: props.split || "vertical", sticky: props.sticky || -1, maxSize: props.maxSize || -1, minSize: props.minSize || -1, keepRatio: !!props.keepRatio, disable: !!props.disable, size: (_a = props.size) !== null && _a !== void 0 ? _a : -1, ratio: (_b = props.ratio) !== null && _b !== void 0 ? _b : -1, mode: props.mode || 'resize', isMainSecond: this.isMainSecond, getContainerSize: this.getContainerSize, getMainSize: this.getMainSize, getMainSizeStyle: this.getMainSizeStyle, setMode: this.setMode, setSize: this.setSize, setDisable: this.setDisable, onMouseDown: this.handleReactStartResize, onTouchStart: this.handleReactStartResize, onClick: this.handleReactEndResize, onTouchEnd: this.handleReactEndResize, onDoubleClick: this.onDoubleClick });
    }
    get mainRef() {
        var _a, _b;
